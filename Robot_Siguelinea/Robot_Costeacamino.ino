const int IN1 = 2;  // Pin digital para controlar sentido giro motor izquierdo
const int IN2 = 3;  // Pin digital para controlar sentido giro motor izquierdo
 
// Definición de variables y constantes relacionadas con el motor derecho
const int IN3 = 4;  // Pin digital para controlar sentido giro motor izquierdo
const int IN4 = 5;  // Pin digital para controlar sentido giro motor izquierdo

//Variables para regular la velocidad
const int ENA = 8;
const int ENB = 9;
